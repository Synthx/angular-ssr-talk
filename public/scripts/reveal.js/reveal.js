...
!((e, t) => {
    ...
    var p = ((e) => {
        if (e) {
            var t = (e) => [].slice.call(e),
                    ...
                    'requestAnimationFrame' in e
                        ? () => {
                              e.cancelAnimationFrame(a),
                                  (a = e.requestAnimationFrame(() => o(s.filter((e) => e.dirty && e.active))));
                          }
                        : () => {},
                r = (e) => () => {
                ...
                c = (e) => 2 !== e.dirty || (2 === e.dirty && e.element.parentNode.clientWidth !== e.availableWidth),
                h = (t) => {
                    var i = e.getComputedStyle(t.element, null);
                    return (
                        (t.currentFontSize = Number.parseFloat(i.getPropertyValue('font-size'))),
    ...
    const m = '.slides section',
        ...
        w = /fade-(down|up|right|left|out|in-then-out|in-then-semi-out)|semi-fade-out|current-visible|shrink|grow/;
    class E {
        constructor(e) {
            this.Reveal = e;
        }
    ...
    const A = (e) => {
        ...
        const a = e.match(/^rgba\s*\(\s*(\d+)\s*,\s*(\d+)\s*,\s*(\d+)\s*\,\s*([\d]+|[\d]*.[\d]+)\s*\)$/i);
        return a
            ? {
    ...
    class L {
        ...
        getAutoAnimateOptions(t, i) {
            ...
            return (
                ...
                t.dataset.autoAnimateDuration && (s.duration = Number.parseFloat(t.dataset.autoAnimateDuration)),
                t.dataset.autoAnimateDelay && (s.delay = Number.parseFloat(t.dataset.autoAnimateDelay)),
                s
            );
        }
                        ...
                        void 0 !== t.from && 'from' === e
                            ...
                            : void 0 !== t.to && 'to' === e
                              ...
                              : ('line-height' === t.property &&
                                    (i = Number.parseFloat(n['line-height']) / Number.parseFloat(n['font-size'])),
    ...
    class C {
        ...
        createPage(e) {
            return (
                (e.scrollTriggers = []),
                (e.indexh = Number.parseInt(e.slideElement.getAttribute('data-index-h'), 10)),
                (e.indexv = Number.parseInt(e.slideElement.getAttribute('data-index-v'), 10)),
                e
            );
        }
        syncProgressBar() {
        ...
        restoreScrollPosition() {
            ...
            e && t === location.origin + location.pathname && (this.viewportElement.scrollTop = Number.parseInt(e, 10));
        }
        activatePage(e) {
            if (!e.active) {
                e.active = !0;
            ...
            i.forEach(function (i, a) {
                if (!1 === i.classList.contains('stack')) {
                    ...
                    (m = Math.min(m, e.pdfMaxPagesPerSlide)),
                        ((1 === m && e.center) || i.classList.contains('center')) && (c = Math.max((r - p) / 2, 0));
    ...
    class P {
        ...
        update(e, t, i = this.Reveal.getCurrentSlide()) {
            ...
            if (
                ...
                if ('number' != typeof e) {
                    ...
                    t && (e = Number.parseInt(t.getAttribute('data-fragment-index') || 0, 10));
                }
        ...
        goto(e, t = 0) {
            ...
            if (i && this.Reveal.getConfig().fragments) {
                ...
                if (s.length) {
                    if ('number' != typeof e) {
                        const t = this.sort(i.querySelectorAll('.fragment:not(.disabled).visible')).pop();
                        e = t ? Number.parseInt(t.getAttribute('data-fragment-index') || 0, 10) : -1;
                    }
                    e += t;
    ...
    class N {
        ...
        onDocumentKeyDown(e) {
            ...
            const a = document.activeElement && !0 === document.activeElement.isContentEditable,
                n =
            ...
            if ('object' == typeof t.keyboard)
                for (d in t.keyboard) 'togglePause' === t.keyboard[d] && c.push(Number.parseInt(d, 10));
    ...
    class M {
        ...
        getIndicesFromHash(e = window.location.hash, t = {}) {
            ...
            if (/^[0-9]*$/.test(s[0]) || !i.length) {
                ...
                return (
                    e.fragmentInURL && ((i = Number.parseInt(s[2], 10)), isNaN(i) && (i = void 0)), { h: n, v: r, f: i }
                );
            }
            {
                let e, t;
    ...
    function $(n, o) {
            ...
            !1 !== k &&
                ...
                (() => {
                    Y.slides.classList.add('no-transition'),
                        u ? Y.wrapper.classList.add('no-hover') : Y.wrapper.classList.remove('no-hover');
                    ae.render(),
                        te.render(),
                        ie.render(),
                        he.render(),
                ...
                setInterval(() => {
                    ((!ne.isActive() && 0 !== Y.wrapper.scrollTop) || 0 !== Y.wrapper.scrollLeft) &&
        ...
        function Ee(t) {
            ...
            Y.wrapper.classList.remove(s.transition),
                ...
                Y.wrapper.setAttribute('data-background-transition', A.backgroundTransition),
                Y.viewport.style.setProperty('--slide-width', 'string' == typeof A.width ? A.width : A.width + 'px'),
                ...
                a > 1 &&
                    ...
                    ((w = new V(Y.wrapper, () => Math.min(Math.max((Date.now() - Q) / J, 0), 1))),
                    w.on('click', Tt),
                    (Z = !1)),
        ...
        function Se() {
            window.addEventListener('resize', Lt, !1),
                ...
                A.focusBodyOnPageVisibilityChange && document.addEventListener('visibilitychange', Ct, !1);
        }
        function Ae() {
            me.unbind(),
                ve.unbind(),
        ...
        function Le(e) {
            'string' == typeof e.layout && (X.layout = e.layout),
                ...
                X.layout ? a(Y.slides, X.layout + ' ' + X.overview) : a(Y.slides, X.overview);
        }
            ...
            if (Y.wrapper && !re.isActive()) {
                ...
                if (!A.disableLayout) {
                    ...
                    De(A.width, A.height),
                        ...
                        ($ = Math.min(i.presentationWidth / i.width, i.presentationHeight / i.height)),
                        ($ = Math.max($, A.minScale)),
                        ($ = Math.min($, A.maxScale)),
                        1 === $ || ne.isActive()
                            ? ((Y.slides.style.zoom = ''),
                    ...
                    s !== $ && Ce({ type: 'resize', data: { oldScale: s, scale: $, size: i } });
                }
                !(() => {
                    if (
                        Y.wrapper &&
        ...
        function Fe(e, t) {
            ...
            return (
                ...
                'string' == typeof a.width &&
                    /%$/.test(a.width) &&
                    (a.width = (Number.parseInt(a.width, 10) / 100) * a.presentationWidth),
                'string' == typeof a.height &&
                    /%$/.test(a.height) &&
                    (a.height = (Number.parseInt(a.height, 10) / 100) * a.presentationHeight),
                a
            );
        }
        function ze(e, t) {
        ...
        function je() {
            if (A.pause) {
                ...
                pt(), Y.wrapper.classList.add('paused'), !1 === e && Ce({ type: 'paused' });
            }
        }
        function Ke() {
            const e = Y.wrapper.classList.contains('paused');
        ...
        function Ye(e, i, s, a) {
            ...
            void 0 !== i || le.isActive() || (i = qe(r[e])),
                g && g.parentNode && g.parentNode.classList.contains('stack') && ze(g.parentNode, h);
            const o = O.concat();
            O.length = 0;
            const l = c || 0,
                d = h || 0;
            ...
            u &&
                ...
                p &&
                !le.isActive() &&
                ((_ = 'running'), (b = _e(g, p, l, d)), b && Y.slides.classList.add('disable-slide-transitions')),
                tt(),
                He(),
                le.isActive() && le.update(),
                void 0 !== s && oe.goto(s),
        ...
        function Je() {
            Ae(),
                ...
                !1 === A.autoPlayMedia ? ee.stopEmbeddedContent(p, { unloadIframes: !1 }) : ee.startEmbeddedContent(p),
        ...
        function tt() {
            ...
            if (a && void 0 !== c) {
                ...
                u && (n = le.isActive() ? 6 : A.mobileViewDistance), re.isActive() && (n = Number.MAX_VALUE);
                for (let r = 0; r < a; r++) {
                    const o = s[r],
                        l = t(o, 'section'),
                        d = l.length;
        ...
        function it({ includeFragments: e = !1 } = {}) {
            ...
            if (
                (A.loop &&
                    (t.length > 1 && ((s.left = !0), (s.right = !0)), i.length > 1 && ((s.up = !0), (s.down = !0))),
                t.length > 1 &&
            ...
            if (e)
                if (ne.isActive())
                    (s = Number.parseInt(e.getAttribute('data-index-h'), 10)),
                        e.getAttribute('data-index-v') && (a = Number.parseInt(e.getAttribute('data-index-v'), 10));
                else {
                    const i = Oe(e),
                        n = i ? e.parentNode : e,
                        r = rt();
        ...
        function vt() {
            J && !Z && ((Z = !0), Ce({ type: 'autoslidepaused' }), clearTimeout(G), w && w.setPlaying(!1));
        }
        function mt() {
        ...
        function Et({ skipFragments: e = !1 } = {}) {
            ...
            if (e || !1 === oe.prev())
                if (it().up) bt({ skipFragments: e });
                    ...
                    let i;
                    if (
                        ((i = A.rtl ? t(Y.wrapper, f + '.future').pop() : t(Y.wrapper, f + '.past').pop()),
        ...
        function St({ skipFragments: e = !1 } = {}) {
            ...
            if (e || !1 === oe.next()) {
                ...
                t.down && t.right && A.loop && We() && (t.down = !1),
                    t.down ? wt({ skipFragments: e }) : A.rtl ? ft({ skipFragments: e }) : yt({ skipFragments: e });
            }
        }
        function At(e) {
            let t = e.data;
        ...
        function xt(e) {
            (document.fullscreenElement || document.webkitFullscreenElement) === Y.wrapper &&
        ...
        const Nt = {
            ...
            initialize: (e) => {
                ...
                if (((k = !0), (Y.wrapper = n), (Y.slides = n.querySelector('.slides')), !Y.slides))
            ...
            destroy: () => {
                (k = !1),
                    !1 !== D &&
                        ...
                        Y.wrapper.classList.remove('ready', 'center', 'has-horizontal-slides', 'has-vertical-slides'),
            ...
            isVerticalSlide: Oe,
            isVerticalStack: (e = p) => e.classList.contains('.stack') || null !== e.querySelector('section'),
            isPaused: Xe,
            isAutoSliding: () => !(!J || Z),
            ...
            setCurrentScrollPage: (e, t, i) => {
                ...
                (g = p),
                    ...
                    a &&
                        (g && (ee.stopEmbeddedContent(g), ee.stopEmbeddedContent(g.slideBackgroundElement)),
