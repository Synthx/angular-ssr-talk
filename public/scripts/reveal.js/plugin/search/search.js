                            ...
                            t.preventDefault(),
                                (() => {
                                    if (l) {
                                        ...
                                        '' === t
                                            ? (r && r.remove(), (i = null))
                                            : ((r = new c('slidecontent')), (i = r.apply(t)), (o = 0));
                                    }
                                    i &&
        ...
        function c(t, n) {
            ...
            (this.setRegex = (e) => {
                        ...
                        if (3 == t.nodeType)
                            if ((i = t.nodeValue) && (f = d.exec(i))) {
                                ...
                                var p = e.getIndices(u),
                                    h = c.length,
                                    y = !1;
                                for (n = 0; n < h; n++) c[n].h === p.h && c[n].v === p.v && (y = !0);
                                y || c.push(p), s[f[0].toLowerCase()] || (s[f[0].toLowerCase()] = r[a++ % r.length]);
                                ...
                                (v.nodeValue = v.nodeValue.substring(f[0].length)), t.parentNode.insertBefore(g, v);
                            }
                    }
                }),
                (this.remove = () => {
                ...
                (this.apply = function (e) {
                    if (null != e && e) return this.remove(), this.setRegex(e), this.hiliteWords(i), c;
                });
        }
        return {
            id: 'search',
