...
!((r, o) => {
    ...
    function u(e) {
        ...
        var o = Number.parseInt(t.dataset.lineNumber),
            a = Number.parseInt(r.dataset.lineNumber);
        if (o == a) return n;
        var i,
            l = t.textContent,
            s = r.textContent;
            ...
            o =
                ((t = e),
                {
                    ...
                    startFrom: ((e, n) => {
                        ...
                        var r = ((e, n) => (e.hasAttribute(n) ? e.getAttribute(n) : null))(e, 'data-ln-start-from');
                        return (
                            null !== r &&
                                (t = ((e, n) => {
                                    if (!e) return n;
...
const Plugin = {
    ...
    highlightBlock: (block) => {
        ...
        if (block.hasAttribute('data-line-numbers')) {
            ...
            if (highlightSteps.length > 1) {
                ...
                var fragmentIndex = Number.parseInt(block.getAttribute('data-fragment-index'), 10);
    ...
    scrollHighlightedLineIntoView: function (block, scrollState, skipAnimation) {
        ...
        viewportHeight -= Number.parseInt(blockStyles.paddingTop) + Number.parseInt(blockStyles.paddingBottom);
        ...
        if (lineTable) targetTop += lineTable.offsetTop - Number.parseInt(blockStyles.paddingTop);
        ...
        return highlightSteps.map((highlights) =>
            highlights.split(Plugin.HIGHLIGHT_LINE_DELIMITER).map((highlight) => {
                ...
                if (/^[\d-]+$/.test(highlight)) {
                    ...
                    var lineStart = Number.parseInt(highlight[0], 10),
                        lineEnd = Number.parseInt(highlight[1], 10);
