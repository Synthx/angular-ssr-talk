!((t, e) => {
    ...
    class R {
        constructor(t) {
            ...
            this.options.pedantic
                ...
                : this.options.gfm &&
                  ((n.block = z.gfm), this.options.breaks ? (n.inline = $.breaks) : (n.inline = $.gfm)),
        ...
        return (n, i, s) => {
            ...
            if (i.async)
                return Promise.resolve(i.hooks ? i.hooks.preprocess(n) : n)
                    .then((e) => t(e, i))
                    .then((t) => (i.walkTokens ? Promise.all(N.walkTokens(t, i.walkTokens)).then(() => t) : t))
                    .then((t) => e(t, i))
    ...
    (N.options = N.setOptions =
        (t) => {
            var n;
            return (N.defaults = { ...N.defaults, ...t }), (n = N.defaults), (e = n), N;
        }),
        (N.getDefaults = t),
        (N.defaults = e),
        (N.use = (...t) => {
            ...
            for (const i of t)
                switch (((n = n.concat(e.call(N, i))), i.type)) {
                    case 'table':
                        ...
                        for (const t of i.rows) for (const i of t) n = n.concat(N.walkTokens(i.tokens, e));
                        break;
                    case 'list':
                    ...
                    default:
                        ...
                        N.defaults.extensions.childTokens[i.type]
                            ? N.defaults.extensions.childTokens[i.type].forEach((t) => {
