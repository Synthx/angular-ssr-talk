...
function d(t, e) {
    ...
    const n = {
        replace: (e, i) => ((i = (i = i.source || i).replace(u, '$1')), (t = t.replace(e, i)), n),
...
class _ {
    ...
    blockquote(t) {
        ...
        if (e) {
            ...
            return (this.lexer.state.top = n), { type: 'blockquote', raw: e[0], tokens: i, text: t };
        }
    }
    list(t) {
        ...
        if (e) {
            ...
            while (t && ((h = !1), (e = k.exec(t))) && !this.rules.block.hr.test(t)) {
                if (
                    ((n = e[0]),
                    ...
                    this.options.pedantic
                        ? ((r = 2), (d = c.trimLeft()))
                        : ((r = e[2].search(/[^ ]/)), (r = r > 4 ? 1 : r), (d = c.slice(r)), (r += e[1].length)),
                    (o = !1),
                    ...
                    while (
                        ...
                        o || p.trim() || (o = !0), (n += u + '\n'), (t = t.substring(u.length + 1)), (c = p.slice(r));
                    }
                }
                f.loose || (l ? (f.loose = !0) : /\n *\n *$/.test(n) && (l = !0)),
                    this.options.gfm &&
    ...
    table(t) {
        ...
        if (e) {
            ...
            if (t.header.length === t.align.length) {
                ...
                for (a = t.header.length, i = 0; i < a; i++) t.header[i].tokens = this.lexer.inline(t.header[i].text);
                for (a = t.rows.length, i = 0; i < a; i++)
                    for (r = t.rows[i], s = 0; s < r.length; s++) r[s].tokens = this.lexer.inline(r[s].text);
                return t;
            }
        }
    }
        ...
        if (e) {
            ...
            if (!this.options.pedantic && /^</.test(t)) {
                ...
                if (t > -1) {
                    ...
                    (e[2] = e[2].substring(0, t)), (e[0] = e[0].substring(0, n).trim()), (e[3] = '');
                }
            }
            let n = e[2],
                i = '';
    ...
    emStrong(t, e, n = '') {
        ...
        if (!s || (s && ('' === n || this.rules.inline.punctuation.exec(n)))) {
            ...
            for (l.lastIndex = 0, e = e.slice(-1 * t.length + n); null != (i = l.exec(e)); ) {
    ...
    codespan(t) {
        ...
        if (e) {
            ...
            const n = /[^ ]/.test(t),
                i = /^ /.test(t) && / $/.test(t);
            return (
                n && i && (t = t.substring(1, t.length - 1)), (t = l(t, !0)), { type: 'codespan', raw: e[0], text: t }
            );
        }
    }
    br(t) {
    ...
    url(t, e) {
        ...
        if ((n = this.rules.inline.url.exec(t))) {
            let t, i;
            if ('@' === n[2]) (t = l(this.options.mangle ? e(n[0]) : n[0])), (i = 'mailto:' + t);
            else {
                let e;
                do {
...
function A(t) {
    ...
    const s = t.length;
    for (e = 0; e < s; e++)
        (n = t.charCodeAt(e)), Math.random() > 0.5 && (n = 'x' + n.toString(16)), (i += '&#' + n + ';');
    return i;
}
($._punctuation = '!"#$%&\'()+\\-.,/:;<=>?@\\[\\]`^{|}~'),
...
class R {
    constructor(t) {
        ...
        this.options.pedantic
            ...
            : this.options.gfm && ((n.block = z.gfm), this.options.breaks ? (n.inline = $.breaks) : (n.inline = $.gfm)),
            ...
            if (
                !(
                    ...
                    this.options.extensions.block.some(
                        (i) =>
                            !!(n = i.call({ lexer: this }, t, e)) && ((t = t.substring(n.raw.length)), e.push(n), !0),
                    )
                )
            )
                if ((n = this.tokenizer.space(t)))
                    ...
                    if (((s = t), this.options.extensions && this.options.extensions.startBlock)) {
                        ...
                        this.options.extensions.startBlock.forEach(function (t) {
                            (i = t.call({ lexer: this }, n)), 'number' == typeof i && i >= 0 && (e = Math.min(e, i));
                        }),
    ...
    inlineTokens(t, e = []) {
        ...
        if (this.tokens.links) {
            ...
            if (t.length > 0)
                while (null != (r = this.tokenizer.rules.inline.reflinkSearch.exec(l)))
        ...
        while (null != (r = this.tokenizer.rules.inline.blockSkip.exec(l)))
            l =
                l.slice(0, r.index) +
                '[' +
                S('a', r[0].length - 2) +
        ...
        while (null != (r = this.tokenizer.rules.inline.escapedEmSt.exec(l)))
            (l =
        ...
        while (t)
            if (
                ...
                if ((n = this.tokenizer.escape(t))) (t = t.substring(n.raw.length)), e.push(n);
                    ...
                    (t = t.substring(n.raw.length)),
                        ...
                        i && 'text' === n.type && 'text' === i.type
                            ? ((i.raw += n.raw), (i.text += n.text))
                            : e.push(n);
                else if ((n = this.tokenizer.emStrong(t, l, o))) (t = t.substring(n.raw.length)), e.push(n);
                ...
                else if ((n = this.tokenizer.autolink(t, A))) (t = t.substring(n.raw.length)), e.push(n);
                    ...
                    if ((n = this.tokenizer.inlineText(s, E)))
                        (t = t.substring(n.raw.length)),
                            ...
                            (a = !0),
                            (i = e[e.length - 1]),
                            i && 'text' === i.type ? ((i.raw += n.raw), (i.text += n.text)) : e.push(n);
                    else if (t) {
                        const e = 'Infinite loop on byte: ' + t.charCodeAt(0);
                        if (this.options.silent) {
                            console.error(e);
...
class L {
    ...
    code(t, e, n) {
        ...
        return (
            (t = t.replace(/\n$/, '') + '\n'),
            i
                ? '<pre><code class="' + this.options.langPrefix + l(i) + '">' + (n ? t : l(t, !0)) + '</code></pre>\n'
    ...
    link(t, e, n) {
        if (null === (t = m(this.options.sanitize, this.options.baseUrl, t))) return n;
        let i = '<a href="' + t + '"';
            ...
            if (
                ...
                switch (d.type) {
                    ...
                    case 'table':
                        ...
                        for (c += this.renderer.tablerow(l), u = '', r = d.rows.length, i = 0; i < r; i++) {
                    ...
                    case 'blockquote':
                        ...
                        continue;
                    case 'list':
                        for (h = d.ordered, g = d.start, m = d.loose, r = d.items.length, u = '', i = 0; i < r; i++)
                            (k = d.items[i]),
                                (w = k.checked),
                                (x = k.task),
                                (f = ''),
        ...
        for (n = 0; n < a; n++)
            if (
                ...
                this.options.extensions &&
                    ...
                    ((s = this.options.extensions.renderers[i.type].call({ parser: this }, i)),
                    !1 !== s ||
    ...
    return (n, i, s) => {
                ...
                O.walkTokens(o, (t) => {
                    'code' === t.type &&
                        ...
                        setTimeout(() => {
                            r(t.text, t.lang, (e, n) => {
                                if (e) return l(e);
                                null != n && n !== t.text && ((t.text = n), (t.escaped = !0)), c--, 0 === c && l();
                            });
                        }, 0));
                }),
                void (0 === c && l())
        ...
        if (i.async)
            return Promise.resolve(i.hooks ? i.hooks.preprocess(n) : n)
                .then((e) => t(e, i))
                .then((t) => (i.walkTokens ? Promise.all(O.walkTokens(t, i.walkTokens)).then(() => t) : t))
                .then((t) => e(t, i))
        ...
        t.forEach((t) => {
                            ...
                            e[t.level] ? e[t.level].unshift(t.tokenizer) : (e[t.level] = [t.tokenizer]),
                                t.start &&
                                    ('block' === t.level
                                        ...
                                        : 'inline' === t.level &&
                                          (e.startInline ? e.startInline.push(t.start) : (e.startInline = [t.start])));
                        }
            ...
            if (t.walkTokens) {
                ...
                n.walkTokens = function (n) {
                    let i = [];
                    return i.push(t.walkTokens.call(this, n)), e && (i = i.concat(e.call(this, n))), i;
                };
            }
            O.setOptions(n);
        });
        ...
        for (const i of t)
            switch (((n = n.concat(e.call(O, i))), i.type)) {
                case 'table':
                    ...
                    for (const t of i.rows) for (const i of t) n = n.concat(O.walkTokens(i.tokens, e));
                    break;
                case 'list':
                ...
                default:
                    ...
                    O.defaults.extensions.childTokens[i.type]
                        ? O.defaults.extensions.childTokens[i.type].forEach((t) => {
...
const N = () => {
    ...
    function s(t) {
        ...
        if (
            (i.hasAttribute('data-notes') && ((a.notes = i.getAttribute('data-notes')), (a.whitespace = 'pre-wrap')), r)
        ) {
            const t = r.querySelector('aside.notes');
            t
                ? ((a.notes = t.innerHTML),
                  (a.markdown = 'string' == typeof t.getAttribute('data-markdown')),
                  (s = null))
                : r.hasAttribute('data-notes') &&
                  ((a.notes = r.getAttribute('data-notes')), (a.whitespace = 'pre-wrap'), (s = null));
        }
        s &&
            s.length &&
        ...
        init: (t) => {
            (e = t),
                /receiver/i.test(window.location.search) ||
                    ...
                    e.addKeyBinding({ keyCode: 83, key: 'S', description: 'Speaker notes view' }, () => {
                        i();
                    }));
        },
        open: i,
