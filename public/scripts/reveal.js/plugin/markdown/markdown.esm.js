    ...
    codespan(e) {
        ...
        if (t) {
            ...
            const n = /[^ ]/.test(e),
                s = /^ /.test(e) && / $/.test(e);
            return (
                n && s && (e = e.substring(1, e.length - 1)), (e = a(e, !0)), { type: 'codespan', raw: t[0], text: e }
            );
        }
    }
    br(e) {
...
(T._punctuation = '!"#$%&\'()+\\-.,/:;<=>?@\\[\\]`^{|}~'),
    ...
    (T.emStrong.rDelimAst = u(T.emStrong.rDelimAst, 'g').replace(/punct/g, T._punctuation).getRegex()),
    (T.emStrong.rDelimUnd = u(T.emStrong.rDelimUnd, 'g').replace(/punct/g, T._punctuation).getRegex()),
    (T._escapes = /\\([!"#$%&'()*+,\-./:;<=>?@\[\]\\^_`{|}~])/g),
    ...
    (T._href = /<(?:\\.|[^\n<>\\])+>|[^\s\x00-\x1f]*/),
    (T._title = /"(?:\\"?|[^"\\])*"|'(?:\\'?|[^'\\])*'|\((?:\\\)?|[^)\\])*\)/),
    (T.link = u(T.link).replace('label', T._label).replace('href', T._href).replace('title', T._title).getRegex()),
    (T.reflink = u(T.reflink).replace('label', T._label).replace('ref', R._label).getRegex()),
    (T.nolink = u(T.nolink).replace('ref', R._label).getRegex()),
    (T.reflinkSearch = u(T.reflinkSearch, 'g').replace('reflink', T.reflink).replace('nolink', T.nolink).getRegex()),
    (T.normal = { ...T }),
    (T.pedantic = {
        ...T.normal,
        strong: {
...
class v {
    constructor(e) {
        ...
        this.options.pedantic
            ...
            : this.options.gfm && ((n.block = R.gfm), this.options.breaks ? (n.inline = T.breaks) : (n.inline = T.gfm)),
            ...
            if (
                !(
                    ...
                    this.options.extensions.block.some(
                        (s) =>
                            !!(n = s.call({ lexer: this }, e, t)) && ((e = e.substring(n.raw.length)), t.push(n), !0),
                    )
                )
            )
...
class I {
    ...
    code(e, t, n) {
        ...
        return (
            (e = e.replace(/\n$/, '') + '\n'),
            s
                ? '<pre><code class="' + this.options.langPrefix + a(s) + '">' + (n ? e : a(e, !0)) + '</code></pre>\n'
        ...
        for (n = 0; n < $; n++)
            if (
                ...
                this.options.extensions &&
                    ...
                    ((_ = this.options.extensions.renderers[u.type].call({ parser: this }, u)),
                    !1 !== _ ||
                        ![
                            'space',
                            'hr',
                                        ...
                                        ? x.tokens.length > 0 && 'paragraph' === x.tokens[0].type
                                            ? ((x.tokens[0].text = w + ' ' + x.tokens[0].text),
                                              x.tokens[0].tokens &&
                                                  ...
                                                  (x.tokens[0].tokens[0].text = w + ' ' + x.tokens[0].tokens[0].text))
    ...
    return (n, s, r) => {
        ...
        if (s.async)
            return Promise.resolve(s.hooks ? s.hooks.preprocess(n) : n)
                .then((t) => e(t, s))
                .then((e) => (s.walkTokens ? Promise.all(M.walkTokens(e, s.walkTokens)).then(() => e) : e))
                .then((e) => t(e, s))
