!((e, t) => {
    ...
    function h(e) {
        return e.replace(c, (e, t) =>
            'colon' === (t = t.toLowerCase())
                ...
                : '#' === t.charAt(0)
                  ? 'x' === t.charAt(1)
                      ? String.fromCharCode(Number.parseInt(t.substring(2), 16))
    ...
    class S {
        ...
        list(e) {
            ...
            if (t) {
                ...
                while (e && ((g = !1), (t = x.exec(e))) && !this.rules.block.hr.test(e)) {
                    if (
                        ((n = t[0]),
                        ...
                        this.options.pedantic
                            ? ((i = 2), (u = c.trimLeft()))
                            : ((i = t[2].search(/[^ ]/)), (i = i > 4 ? 1 : i), (u = c.slice(i)), (i += t[1].length)),
                        (o = !1),
            ...
            if (t) {
                ...
                if (e.header.length === e.align.length) {
                    ...
                    for (l = e.rows.length, s = 0; s < l; s++)
                        for (i = e.rows[s], r = 0; r < i.length; r++) i[r].tokens = this.lexer.inline(i[r].text);
                    return e;
                }
            }
        }
        ...
        url(e, t) {
            ...
            if ((n = this.rules.inline.url.exec(e))) {
                let e, s;
                if ('@' === n[2]) (e = a(this.options.mangle ? t(n[0]) : n[0])), (s = 'mailto:' + e);
                else {
                    let t;
                    do {
    ...
    (T.def = u(T.def).replace('label', T._label).replace('title', T._title).getRegex()),
        (T.bullet = /(?:[*+-]|\d{1,9}[.)])/),
        ...
        (T.paragraph = u(T._paragraph)
            ...
            .replace('tag', T._tag)
            .getRegex()),
        (T.blockquote = u(T.blockquote).replace('paragraph', T.paragraph).getRegex()),
        (T.normal = { ...T }),
        (T.gfm = {
            ...T.normal,
    ...
    function E(e) {
        ...
        const r = e.length;
        for (t = 0; t < r; t++)
            (n = e.charCodeAt(t)), Math.random() > 0.5 && (n = 'x' + n.toString(16)), (s += '&#' + n + ';');
        return s;
    }
    (R._punctuation = '!"#$%&\'()+\\-.,/:;<=>?@\\[\\]`^{|}~'),
        ...
        (R.emStrong.lDelim = u(R.emStrong.lDelim).replace(/punct/g, R._punctuation).getRegex()),
        (R.emStrong.rDelimAst = u(R.emStrong.rDelimAst, 'g').replace(/punct/g, R._punctuation).getRegex()),
        (R.emStrong.rDelimUnd = u(R.emStrong.rDelimUnd, 'g').replace(/punct/g, R._punctuation).getRegex()),
        (R._escapes = /\\([!"#$%&'()*+,\-./:;<=>?@\[\]\\^_`{|}~])/g),
        (R._scheme = /[a-zA-Z][a-zA-Z0-9+.-]{1,31}/),
        (R._email =
            /[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+(@)[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)+(?![-_])/),
        (R.autolink = u(R.autolink).replace('scheme', R._scheme).replace('email', R._email).getRegex()),
        (R._attribute = /\s+[a-zA-Z:_][\w.:-]*(?:\s*=\s*"[^"]*"|\s*=\s*'[^']*'|\s*=\s*[^\s"'=<>`]+)?/),
        (R.tag = u(R.tag).replace('comment', R._comment).replace('attribute', R._attribute).getRegex()),
        (R._label = /(?:\[(?:\\.|[^\[\]\\])*\]|\\.|`[^`]*`|[^\[\]\\`])*?/),
        (R._href = /<(?:\\.|[^\n<>\\])+>|[^\s\x00-\x1f]*/),
        (R._title = /"(?:\\"?|[^"\\])*"|'(?:\\'?|[^'\\])*'|\((?:\\\)?|[^)\\])*\)/),
        (R.link = u(R.link).replace('label', R._label).replace('href', R._href).replace('title', R._title).getRegex()),
        (R.reflink = u(R.reflink).replace('label', R._label).replace('ref', T._label).getRegex()),
        ...
        (R.gfm.url = u(R.gfm.url, 'i').replace('email', R.gfm._extended_email).getRegex()),
        (R.breaks = {
            ...R.gfm,
    ...
    class v {
        constructor(e) {
            ...
            this.options.pedantic
                ...
                : this.options.gfm &&
                  ((n.block = T.gfm), this.options.breaks ? (n.inline = R.breaks) : (n.inline = R.gfm)),
        ...
        inlineTokens(e, t = []) {
            ...
            if (this.tokens.links) {
                ...
                if (e.length > 0)
                    while (null != (i = this.tokenizer.rules.inline.reflinkSearch.exec(a)))
            ...
            while (null != (i = this.tokenizer.rules.inline.blockSkip.exec(a)))
                a =
                    a.slice(0, i.index) +
                    '[' +
                    $('a', i[0].length - 2) +
            ...
            while (null != (i = this.tokenizer.rules.inline.escapedEmSt.exec(a)))
                (a =
            ...
            while (e)
                if (
                    ...
                    else if ((n = this.tokenizer.autolink(e, E))) (e = e.substring(n.raw.length)), t.push(n);
                    ...
                    switch (u.type) {
                        ...
                        case 'table':
                            for (c = '', a = '', i = u.header.length, s = 0; s < i; s++)
                                a += this.renderer.tablecell(this.parseInline(u.header[s].tokens), {
                                    header: !0,
                                    align: u.align[s],
                                });
                        ...
                        case 'blockquote':
                            ...
                            continue;
                        case 'list':
                            for (g = u.ordered, d = u.start, f = u.loose, i = u.items.length, p = '', s = 0; s < i; s++)
                                (x = u.items[s]),
                                    (m = x.checked),
                                    (b = x.task),
                                    (k = ''),
        ...
        return (n, s, r) => {
            ...
            if (s.async)
                return Promise.resolve(s.hooks ? s.hooks.preprocess(n) : n)
                    .then((t) => e(t, s))
                    .then((e) => (s.walkTokens ? Promise.all(P.walkTokens(e, s.walkTokens)).then(() => e) : e))
                    .then((e) => t(e, s))
    ...
    (P.options = P.setOptions =
        (e) => {
            var n;
            return (P.defaults = { ...P.defaults, ...e }), (n = P.defaults), (t = n), P;
        }),
        (P.getDefaults = e),
        (P.defaults = t),
        (P.use = (...e) => {
            ...
            for (const s of e)
                switch (((n = n.concat(t.call(P, s))), s.type)) {
                    case 'table':
                        ...
                        for (const e of s.rows) for (const s of e) n = n.concat(P.walkTokens(s.tokens, t));
                        break;
                    case 'list':
                    ...
                    default:
                        ...
                        P.defaults.extensions.childTokens[s.type]
                            ? P.defaults.extensions.childTokens[s.type].forEach((e) => {
    ...
    return () => {
        ...
        function s(t) {
            ...
            return (
                ((t = t || {}).separator = t.separator || n?.separator || '\r?\n---\r?\n'),
                (t.verticalSeparator = t.verticalSeparator || n?.verticalSeparator || null),
                (t.notesSeparator = t.notesSeparator || n?.notesSeparator || '^s*notes?:'),
        ...
        function r(e, t) {
            ...
            return (
                2 === n.length && (e = n[0] + '<aside class="notes">' + P(n[1].trim()) + '</aside>'),
            ...
            for (let e = 0, n = p.length; e < n; e++)
                p[e] instanceof Array
                    ? ((u += '<section ' + t.attributes + '>'),
                      ...
                      (u += '</section>'))
                    : (u += '<section ' + t.attributes + ' data-markdown>' + r(p[e], t) + '</section>');
            return u;
        }
        function l(e) {
        ...
        function o(e, t, n) {
            ...
            if ((i = s.exec(o))) {
                const n = i[1];
                for (o = o.substring(0, i.index) + o.substring(s.lastIndex), e.nodeValue = o; (l = r.exec(n)); )
            ...
            if (null !== t && void 0 !== t.childNodes && t.childNodes.length > 0) {
                ...
                for (let i = 0; i < t.childNodes.length; i++) {
                    ...
                    'section' === l.nodeName && ((o = l), (n = l)),
                        ('function' != typeof l.setAttribute && l.nodeType !== Node.COMMENT_NODE) || a(o, l, n, s, r);
                }
            }
